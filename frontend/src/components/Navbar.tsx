        ...
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl border border-slate-100 relative animate-in zoom-in-95 duration-200">
            ...
            <form
              onSubmit={(e) => {
                e.preventDefault();
                alert('Thank you! You have subscribed to Nitin Sir Academic Alerts.');
            ...
            >
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-navy-800"
                />
              </div>
              <div>
                <label className="block font-bold text-slate-700 mb-1">Field of Interest</label>
                <select className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-navy-800 bg-white">
                  <option>Engineering & Tech</option>
                  <option>Physical & Life Sciences</option>
                  <option>Agricultural & Biological Sciences</option>
              ...
              <button
                type="submit"
                className="w-full py-3 text-xs font-bold text-white bg-navy-900 hover:bg-navy-850 rounded-xl shadow-lg transition-all"
              >
