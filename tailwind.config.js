  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'brutal-blue': '4px 4px 0px 0px #3366ff',
        'brutal-green': '4px 4px 0px 0px #00cc66',
        'brutal-navy': '4px 4px 0px 0px #001c3b',
        'academic': '0 4px 20px -2px rgba(0, 28, 59, 0.08)',
        'academic-lg': '0 10px 30px -5px rgba(0, 28, 59, 0.12)',
        'brutal-inset': 'inset 4px 4px 0px 0px rgba(0,0,0,0.15)',
      },
      animation: {
