  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'brutal-yellow': '4px 4px 0px 0px #f59e0b',
        'brutal-red': '4px 4px 0px 0px #dc2626',
        'brutal-blue': '4px 4px 0px 0px #1e40af',
        'brutal-green': '4px 4px 0px 0px #059669',
        'brutal-navy': '4px 4px 0px 0px #111827',
        'academic': '0 4px 20px -2px rgba(17, 24, 39, 0.08)',
        'academic-lg': '0 10px 30px -5px rgba(17, 24, 39, 0.12)',
        'brutal-inset': 'inset 4px 4px 0px 0px rgba(17,24,39,0.15)',
      },
      animation: {
