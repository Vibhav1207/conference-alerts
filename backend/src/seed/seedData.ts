    ...
    const events = [
      {
        ...
        description:
          'ICQCAI 2026 brings together international researchers, industry pioneers, and academic leaders to share groundbreaking developments at the intersection of Quantum Algorithms, Machine Learning Architectures, and Quantum Hardware acceleration.',
        topics: [
      ...
      },
      {
        ...
        description:
          'A fully-funded 3-month research internship at CERN for undergraduate and master students in physics, computer science, and bio-engineering to work on high-energy particle simulation and biophysics.',
        topics: [
